...
(function () {
  ...
  //   // Split the pathname to get the section name
  //   const sections = pathname.split("#");

  //   // Extract the section name (assuming it's the last part of the path)
  //   const sectionName = sections[sections.length - 1];

  //   console.log(sectionName); // Output: the extracted section name
  // });
})();
